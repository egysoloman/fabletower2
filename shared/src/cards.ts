...
reg(c({ id: 'portscan', name: 'Port Scan', type: 'skill', rarity: 'common', char: 'runner', cost: 0, target: 'enemy', effects: [{ k: 'status', to: 'target', id: 'vuln', n: 1 }, { k: 'draw', n: 1 }], upEffects: [{ k: 'status', to: 'target', id: 'vuln', n: 2 }, { k: 'draw', n: 1 }] }))
reg(c({ id: 'ransomkit', name: 'Ransom Kit', type: 'attack', rarity: 'uncommon', char: 'runner', cost: 1, target: 'enemy', effects: [{ k: 'dmg', n: 6 }, { k: 'status', to: 'target', id: 'weak', n: 1 }, { k: 'status', to: 'target', id: 'vuln', n: 1 }], upEffects: [{ k: 'dmg', n: 9 }, { k: 'status', to: 'target', id: 'weak', n: 1 }, { k: 'status', to: 'target', id: 'vuln', n: 1 }] }))
reg(c({ id: 'mirrorsite', name: 'Mirror Site', type: 'skill', rarity: 'uncommon', char: 'runner', cost: 1, target: 'none', effects: [{ k: 'doubleBlock' }], upEffects: [{ k: 'block', n: 4 }, { k: 'doubleBlock' }] }))
reg(c({ id: 'cronjob', name: 'Cron Job', type: 'power', rarity: 'uncommon', char: 'runner', cost: 1, target: 'none', effects: [{ k: 'status', to: 'self', id: 'plating', n: 1 }, { k: 'status', to: 'self', id: 'turret', n: 1 }], upEffects: [{ k: 'status', to: 'self', id: 'plating', n: 2 }, { k: 'status', to: 'self', id: 'turret', n: 1 }] }))
reg(c({ id: 'greyice', name: 'Grey ICE', type: 'skill', rarity: 'common', char: 'runner', cost: 1, target: 'none', effects: [{ k: 'block', n: 5 }, { k: 'status', to: 'self', id: 'thorns', n: 1 }], upEffects: [{ k: 'block', n: 7 }, { k: 'status', to: 'self', id: 'thorns', n: 2 }] }))
reg(c({ id: 'forkjoin', name: 'Fork-Join', type: 'attack', rarity: 'rare', char: 'runner', cost: 2, target: 'enemy', effects: [{ k: 'dmg', n: 5, times: 3 }, { k: 'draw', n: 1 }], upEffects: [{ k: 'dmg', n: 6, times: 3 }, { k: 'draw', n: 1 }] }))
reg(c({ id: 'memoize', name: 'Memoize', type: 'skill', rarity: 'uncommon', char: 'runner', cost: 1, target: 'none', retain: true, effects: [{ k: 'block', n: 6 }, { k: 'draw', n: 1 }], upEffects: [{ k: 'block', n: 9 }, { k: 'draw', n: 1 }] }))
reg(c({ id: 'pingflood', name: 'Ping Flood', type: 'attack', rarity: 'common', char: 'runner', cost: 1, target: 'none', effects: [{ k: 'dmgAll', n: 3 }, { k: 'status', to: 'all', id: 'corrupt', n: 1 }], upEffects: [{ k: 'dmgAll', n: 4 }, { k: 'status', to: 'all', id: 'corrupt', n: 2 }] }))
reg(c({ id: 'checksum', name: 'Checksum', type: 'skill', rarity: 'common', char: 'runner', cost: 1, target: 'none', effects: [{ k: 'block', n: 8 }], upEffects: [{ k: 'block', n: 11 }] }))
reg(c({ id: 'coldboot', name: 'Cold Boot', type: 'skill', rarity: 'rare', char: 'runner', cost: 0, target: 'none', innate: true, exhaust: true, upExhaust: true, effects: [{ k: 'energy', n: 1 }, { k: 'draw', n: 1 }], upEffects: [{ k: 'energy', n: 2 }, { k: 'draw', n: 1 }] }))
reg(c({ id: 'firewalk', name: 'Firewalk', type: 'attack', rarity: 'common', char: 'vector', cost: 1, target: 'enemy', effects: [{ k: 'dmgHeatBonus', n: 6, bonus: 4, threshold: 3 }], upEffects: [{ k: 'dmgHeatBonus', n: 9, bonus: 5, threshold: 3 }] }))
reg(c({ id: 'coalbed', name: 'Coal Bed', type: 'power', rarity: 'uncommon', char: 'vector', cost: 1, target: 'none', effects: [{ k: 'status', to: 'self', id: 'plating', n: 1 }, { k: 'status', to: 'self', id: 'heat', n: 2 }], upEffects: [{ k: 'status', to: 'self', id: 'plating', n: 2 }, { k: 'status', to: 'self', id: 'heat', n: 2 }] }))
reg(c({ id: 'blastfurnace', name: 'Blast Furnace', type: 'attack', rarity: 'rare', char: 'vector', cost: 2, target: 'none', effects: [{ k: 'ventDmgAll', mult: 2 }, { k: 'status', to: 'self', id: 'heat', n: 3 }], upEffects: [{ k: 'ventDmgAll', mult: 3 }, { k: 'status', to: 'self', id: 'heat', n: 3 }] }))
reg(c({ id: 'heatlamp', name: 'Heat Lamp', type: 'skill', rarity: 'common', char: 'vector', cost: 1, target: 'none', effects: [{ k: 'heal', n: 3 }, { k: 'status', to: 'self', id: 'heat', n: 2 }], upEffects: [{ k: 'heal', n: 5 }, { k: 'status', to: 'self', id: 'heat', n: 2 }] }))
reg(c({ id: 'slagheap', name: 'Slag Heap', type: 'skill', rarity: 'common', char: 'vector', cost: 2, target: 'none', effects: [{ k: 'block', n: 13 }], upEffects: [{ k: 'block', n: 17 }] }))
reg(c({ id: 'meltvein', name: 'Molten Vein', type: 'attack', rarity: 'uncommon', char: 'vector', cost: 1, target: 'enemy', effects: [{ k: 'dmg', n: 5 }, { k: 'ventDmg', mult: 1 }], upEffects: [{ k: 'dmg', n: 8 }, { k: 'ventDmg', mult: 1 }] }))
reg(c({ id: 'furnacedoor', name: 'Furnace Door', type: 'skill', rarity: 'uncommon', char: 'vector', cost: 0, target: 'none', ethereal: true, effects: [{ k: 'block', n: 6 }], upEffects: [{ k: 'block', n: 9 }] }))
reg(c({ id: 'solarwind', name: 'Solar Wind', type: 'attack', rarity: 'uncommon', char: 'vector', cost: 2, target: 'none', effects: [{ k: 'dmgAll', n: 8 }, { k: 'heatCool', n: 2 }], upEffects: [{ k: 'dmgAll', n: 11 }, { k: 'heatCool', n: 3 }] }))
reg(c({ id: 'ashfall', name: 'Ashfall', type: 'skill', rarity: 'rare', char: 'vector', cost: 1, target: 'none', effects: [{ k: 'status', to: 'all', id: 'weak', n: 2 }, { k: 'status', to: 'self', id: 'heat', n: 1 }], upEffects: [{ k: 'status', to: 'all', id: 'weak', n: 3 }, { k: 'status', to: 'self', id: 'heat', n: 1 }] }))
reg(c({ id: 'tinderbox', name: 'Tinderbox', type: 'skill', rarity: 'common', char: 'vector', cost: 0, target: 'none', exhaust: true, upExhaust: true, effects: [{ k: 'status', to: 'self', id: 'heat', n: 4 }], upEffects: [{ k: 'status', to: 'self', id: 'heat', n: 5 }, { k: 'draw', n: 1 }] }))
reg(c({ id: 'glintstep', name: 'Glint Step', type: 'skill', rarity: 'common', char: 'ghost', cost: 1, target: 'none', effects: [{ k: 'block', n: 5 }, { k: 'draw', n: 1 }], upEffects: [{ k: 'block', n: 7 }, { k: 'draw', n: 1 }] }))
reg(c({ id: 'nightparade', name: 'Night Parade', type: 'attack', rarity: 'rare', char: 'ghost', cost: 2, target: 'none', effects: [{ k: 'dmgAll', n: 7 }, { k: 'enterStance', id: 'stealth' }], upEffects: [{ k: 'dmgAll', n: 10 }, { k: 'enterStance', id: 'stealth' }] }))
reg(c({ id: 'polaris', name: 'Polaris', type: 'power', rarity: 'uncommon', char: 'ghost', cost: 2, target: 'none', effects: [{ k: 'status', to: 'self', id: 'stancewall', n: 2 }, { k: 'status', to: 'self', id: 'regen', n: 1 }], upEffects: [{ k: 'status', to: 'self', id: 'stancewall', n: 3 }, { k: 'status', to: 'self', id: 'regen', n: 1 }] }))
reg(c({ id: 'glassdance', name: 'Glass Dance', type: 'attack', rarity: 'uncommon', char: 'ghost', cost: 1, target: 'enemy', ethereal: true, effects: [{ k: 'dmg', n: 10 }, { k: 'draw', n: 1 }], upEffects: [{ k: 'dmg', n: 14 }, { k: 'draw', n: 1 }] }))
reg(c({ id: 'lanternlight', name: 'Lantern Light', type: 'skill', rarity: 'common', char: 'ghost', cost: 1, target: 'enemy', effects: [{ k: 'status', to: 'target', id: 'weak', n: 2 }], upEffects: [{ k: 'status', to: 'target', id: 'weak', n: 3 }] }))
reg(c({ id: 'thresholdstep', name: 'Threshold Step', type: 'attack', rarity: 'common', char: 'ghost', cost: 2, target: 'enemy', effects: [{ k: 'dmg', n: 11 }, { k: 'enterStance', id: 'overdrive' }], upEffects: [{ k: 'dmg', n: 14 }, { k: 'enterStance', id: 'overdrive' }] }))
reg(c({ id: 'vanishpoint', name: 'Vanishing Point', type: 'skill', rarity: 'rare', char: 'ghost', cost: 2, upCost: 1, target: 'none', effects: [{ k: 'enterStance', id: 'stealth' }, { k: 'block', n: 8 }, { k: 'draw', n: 1 }], upEffects: [{ k: 'enterStance', id: 'stealth' }, { k: 'block', n: 8 }, { k: 'draw', n: 1 }] }))
reg(c({ id: 'halfmoon', name: 'Half Moon', type: 'attack', rarity: 'common', char: 'ghost', cost: 1, target: 'none', effects: [{ k: 'dmgAll', n: 5 }], upEffects: [{ k: 'dmgAll', n: 7 }] }))
reg(c({ id: 'encoreloop', name: 'Encore Loop', type: 'power', rarity: 'rare', char: 'ghost', cost: 2, target: 'none', effects: [{ k: 'status', to: 'self', id: 'tempoloop', n: 1 }, { k: 'status', to: 'self', id: 'stancewall', n: 1 }], upEffects: [{ k: 'status', to: 'self', id: 'tempoloop', n: 1 }, { k: 'status', to: 'self', id: 'stancewall', n: 2 }] }))
reg(c({ id: 'gossamer', name: 'Gossamer', type: 'skill', rarity: 'uncommon', char: 'ghost', cost: 0, target: 'none', effects: [{ k: 'block', n: 4 }, { k: 'enterStance', id: 'none' }], upEffects: [{ k: 'block', n: 7 }, { k: 'enterStance', id: 'none' }] }))
reg(c({ id: 'relayburst', name: 'Relay Burst', type: 'attack', rarity: 'common', char: 'array', cost: 1, target: 'enemy', effects: [{ k: 'dmg', n: 8 }], upEffects: [{ k: 'dmg', n: 12 }] }))
reg(c({ id: 'sentinelpair', name: 'Sentinel Pair', type: 'skill', rarity: 'rare', char: 'array', cost: 3, upCost: 2, target: 'none', effects: [{ k: 'summonAlly', id: 'ferrodrone' }, { k: 'summonAlly', id: 'bulwarkpod' }], upEffects: [{ k: 'summonAlly', id: 'ferrodrone' }, { k: 'summonAlly', id: 'bulwarkpod' }] }))
reg(c({ id: 'signaljam', name: 'Signal Jam', type: 'skill', rarity: 'uncommon', char: 'array', cost: 1, target: 'none', effects: [{ k: 'status', to: 'all', id: 'weak', n: 1 }, { k: 'block', n: 4 }], upEffects: [{ k: 'status', to: 'all', id: 'weak', n: 2 }, { k: 'block', n: 4 }] }))
reg(c({ id: 'diagnostics', name: 'Diagnostics', type: 'skill', rarity: 'common', char: 'array', cost: 0, target: 'none', effects: [{ k: 'draw', n: 1 }, { k: 'status', to: 'self', id: 'plating', n: 1 }], upEffects: [{ k: 'draw', n: 2 }, { k: 'status', to: 'self', id: 'plating', n: 1 }] }))
reg(c({ id: 'overvoltgrid', name: 'Overvolt Grid', type: 'attack', rarity: 'uncommon', char: 'array', cost: 2, target: 'enemy', effects: [{ k: 'dmgPerAuto', base: 5, per: 2 }, { k: 'status', to: 'self', id: 'turret', n: 1 }], upEffects: [{ k: 'dmgPerAuto', base: 7, per: 2 }, { k: 'status', to: 'self', id: 'turret', n: 1 }] }))
reg(c({ id: 'meshshield', name: 'Mesh Shield', type: 'skill', rarity: 'common', char: 'array', cost: 1, target: 'none', effects: [{ k: 'block', n: 6 }, { k: 'status', to: 'self', id: 'plating', n: 1 }], upEffects: [{ k: 'block', n: 8 }, { k: 'status', to: 'self', id: 'plating', n: 2 }] }))
reg(c({ id: 'workerpool', name: 'Worker Pool', type: 'power', rarity: 'rare', char: 'array', cost: 3, upCost: 2, target: 'none', effects: [{ k: 'status', to: 'self', id: 'focus', n: 1 }, { k: 'status', to: 'self', id: 'turret', n: 2 }], upEffects: [{ k: 'status', to: 'self', id: 'focus', n: 1 }, { k: 'status', to: 'self', id: 'turret', n: 2 }] }))
reg(c({ id: 'faradaymesh', name: 'Faraday Mesh', type: 'skill', rarity: 'rare', char: 'array', cost: 2, target: 'none', exhaust: true, upExhaust: true, effects: [{ k: 'status', to: 'self', id: 'artifact', n: 1 }, { k: 'block', n: 6 }], upEffects: [{ k: 'status', to: 'self', id: 'artifact', n: 1 }, { k: 'block', n: 10 }] }))
reg(c({ id: 'chainlightning', name: 'Chain Lightning', type: 'attack', rarity: 'uncommon', char: 'array', cost: 1, target: 'none', effects: [{ k: 'dmgAll', n: 4, times: 2 }], upEffects: [{ k: 'dmgAll', n: 5, times: 2 }] }))
reg(c({ id: 'repairbay', name: 'Repair Bay', type: 'skill', rarity: 'uncommon', char: 'array', cost: 1, target: 'none', exhaust: true, upExhaust: true, effects: [{ k: 'heal', n: 8 }], upEffects: [{ k: 'heal', n: 12 }] }))
reg(c({ id: 'crowbar', name: 'Crowbar', type: 'attack', rarity: 'common', cost: 1, target: 'enemy', effects: [{ k: 'dmgVulnBonus', n: 6, bonus: 4 }], upEffects: [{ k: 'dmgVulnBonus', n: 8, bonus: 6 }] }))
reg(c({ id: 'dumpsterfind', name: 'Dumpster Find', type: 'skill', rarity: 'common', cost: 0, target: 'none', exhaust: true, upExhaust: true, effects: [{ k: 'draw', n: 2 }], upEffects: [{ k: 'draw', n: 3 }] }))
reg(c({ id: 'neonvisor', name: 'Neon Visor', type: 'power', rarity: 'uncommon', cost: 1, target: 'none', effects: [{ k: 'status', to: 'self', id: 'drawGain', n: 1 }], upEffects: [{ k: 'status', to: 'self', id: 'drawGain', n: 1 }, { k: 'draw', n: 2 }] }))
reg(c({ id: 'riotshield', name: 'Riot Shield', type: 'skill', rarity: 'uncommon', cost: 2, target: 'none', effects: [{ k: 'block', n: 10 }, { k: 'status', to: 'self', id: 'thorns', n: 1 }], upEffects: [{ k: 'block', n: 13 }, { k: 'status', to: 'self', id: 'thorns', n: 2 }] }))
reg(c({ id: 'ionround', name: 'Ion Round', type: 'attack', rarity: 'uncommon', cost: 1, target: 'enemy', effects: [{ k: 'dmg', n: 7 }, { k: 'status', to: 'target', id: 'weak', n: 1 }], upEffects: [{ k: 'dmg', n: 10 }, { k: 'status', to: 'target', id: 'weak', n: 1 }] }))
reg(c({ id: 'contraband', name: 'Contraband Cell', type: 'skill', rarity: 'rare', cost: 0, target: 'none', exhaust: true, upExhaust: true, effects: [{ k: 'energy', n: 2 }, { k: 'selfDmg', n: 3 }], upEffects: [{ k: 'energy', n: 2 }, { k: 'selfDmg', n: 1 }] }))
reg(c({ id: 'stimpatch', name: 'Stim Patch', type: 'skill', rarity: 'common', cost: 1, target: 'ally', effects: [{ k: 'heal', n: 5 }, { k: 'status', to: 'self', id: 'str', n: 1 }], upEffects: [{ k: 'heal', n: 8 }, { k: 'status', to: 'self', id: 'str', n: 1 }] }))
reg(c({ id: 'barricadekit', name: 'Barricade Kit', type: 'skill', rarity: 'uncommon', cost: 1, target: 'ally', effects: [{ k: 'block', n: 6 }, { k: 'status', to: 'self', id: 'plating', n: 1 }], upEffects: [{ k: 'block', n: 9 }, { k: 'status', to: 'self', id: 'plating', n: 1 }] }))
reg(c({ id: 'scrapcannon', name: 'Scrap Cannon', type: 'attack', rarity: 'rare', cost: 3, target: 'none', effects: [{ k: 'dmgAll', n: 12 }, { k: 'status', to: 'all', id: 'vuln', n: 1 }], upEffects: [{ k: 'dmgAll', n: 15 }, { k: 'status', to: 'all', id: 'vuln', n: 2 }] }))

// --- Volume: cycle 32 -------------------------------------------------------

reg(c({ id: 'sqlslam', name: 'SQL Slam', type: 'attack', rarity: 'common', char: 'runner', cost: 2, target: 'enemy', effects: [{ k: 'dmg', n: 13 }], upEffects: [{ k: 'dmg', n: 17 }] }))
reg(c({ id: 'vpnveil', name: 'VPN Veil', type: 'skill', rarity: 'uncommon', char: 'runner', cost: 1, target: 'none', effects: [{ k: 'block', n: 7 }, { k: 'draw', n: 1 }], upEffects: [{ k: 'block', n: 10 }, { k: 'draw', n: 1 }] }))
reg(c({ id: 'wormrider', name: 'Worm Rider', type: 'attack', rarity: 'uncommon', char: 'runner', cost: 1, target: 'enemy', effects: [{ k: 'dmgPerCorrupt', mult: 2 }, { k: 'status', to: 'target', id: 'corrupt', n: 2 }], upEffects: [{ k: 'dmgPerCorrupt', mult: 2 }, { k: 'status', to: 'target', id: 'corrupt', n: 4 }] }))
reg(c({ id: 'debugger', name: 'Debugger', type: 'skill', rarity: 'rare', char: 'runner', cost: 1, target: 'none', exhaust: true, upExhaust: true, effects: [{ k: 'cleanse' }, { k: 'heal', n: 6 }], upEffects: [{ k: 'cleanse' }, { k: 'heal', n: 10 }] }))
reg(c({ id: 'packetstorm', name: 'Packet Storm', type: 'attack', rarity: 'uncommon', char: 'runner', cost: 2, target: 'none', effects: [{ k: 'dmgAll', n: 5, times: 2 }], upEffects: [{ k: 'dmgAll', n: 7, times: 2 }] }))
reg(c({ id: 'ghostwrite', name: 'Ghostwrite', type: 'skill', rarity: 'common', char: 'runner', cost: 0, target: 'none', ethereal: true, effects: [{ k: 'draw', n: 2 }], upEffects: [{ k: 'draw', n: 3 }] }))
reg(c({ id: 'trapdoorfn', name: 'Trapdoor Function', type: 'skill', rarity: 'uncommon', char: 'runner', cost: 2, target: 'none', effects: [{ k: 'block', n: 9 }, { k: 'status', to: 'self', id: 'kernel', n: 1 }], upEffects: [{ k: 'block', n: 12 }, { k: 'status', to: 'self', id: 'kernel', n: 1 }] }))
reg(c({ id: 'rootca', name: 'Root CA', type: 'power', rarity: 'rare', char: 'runner', cost: 2, target: 'none', effects: [{ k: 'status', to: 'self', id: 'barricade', n: 1 }], upEffects: [{ k: 'status', to: 'self', id: 'barricade', n: 1 }, { k: 'block', n: 8 }] }))
reg(c({ id: 'bitshift', name: 'Bit Shift', type: 'attack', rarity: 'common', char: 'runner', cost: 0, target: 'enemy', effects: [{ k: 'dmg', n: 3 }, { k: 'status', to: 'target', id: 'corrupt', n: 1 }], upEffects: [{ k: 'dmg', n: 5 }, { k: 'status', to: 'target', id: 'corrupt', n: 2 }] }))
reg(c({ id: 'hotswap', name: 'Hot Swap', type: 'skill', rarity: 'common', char: 'runner', cost: 1, target: 'none', effects: [{ k: 'draw', n: 2 }, { k: 'block', n: 3 }], upEffects: [{ k: 'draw', n: 2 }, { k: 'block', n: 6 }] }))
reg(c({ id: 'shadowdaemon', name: 'Shadow Daemon', type: 'skill', rarity: 'rare', char: 'runner', cost: 2, target: 'none', effects: [{ k: 'summonAlly', id: 'proxyworm' }, { k: 'status', to: 'self', id: 'viral', n: 1 }], upEffects: [{ k: 'summonAlly', id: 'proxyhydra' }, { k: 'status', to: 'self', id: 'viral', n: 1 }] }))
reg(c({ id: 'pyreblade', name: 'Pyre Blade', type: 'attack', rarity: 'common', char: 'vector', cost: 1, target: 'enemy', effects: [{ k: 'dmg', n: 9 }, { k: 'status', to: 'self', id: 'heat', n: 4 }], upEffects: [{ k: 'dmg', n: 13 }, { k: 'status', to: 'self', id: 'heat', n: 4 }] }))
reg(c({ id: 'crucible', name: 'Crucible', type: 'power', rarity: 'rare', char: 'vector', cost: 2, target: 'none', effects: [{ k: 'status', to: 'self', id: 'coolant', n: 4 }, { k: 'status', to: 'self', id: 'str', n: 1 }], upEffects: [{ k: 'status', to: 'self', id: 'coolant', n: 5 }, { k: 'status', to: 'self', id: 'str', n: 2 }] }))
reg(c({ id: 'emberling', name: 'Emberling', type: 'skill', rarity: 'uncommon', char: 'vector', cost: 1, target: 'none', effects: [{ k: 'summonAlly', id: 'cinderimp' }], upEffects: [{ k: 'summonAlly', id: 'cinderfiend' }] }))
reg(c({ id: 'quenchguard', name: 'Quench Guard', type: 'skill', rarity: 'common', char: 'vector', cost: 1, target: 'none', effects: [{ k: 'block', n: 6 }, { k: 'heatCool', n: 2 }], upEffects: [{ k: 'block', n: 9 }, { k: 'heatCool', n: 2 }] }))
reg(c({ id: 'volcanicvow', name: 'Volcanic Vow', type: 'power', rarity: 'uncommon', char: 'vector', cost: 1, target: 'none', effects: [{ k: 'status', to: 'self', id: 'thorns', n: 2 }, { k: 'status', to: 'self', id: 'heat', n: 1 }], upEffects: [{ k: 'status', to: 'self', id: 'thorns', n: 3 }, { k: 'status', to: 'self', id: 'heat', n: 1 }] }))
reg(c({ id: 'flashover', name: 'Flashover', type: 'attack', rarity: 'rare', char: 'vector', cost: 1, target: 'enemy', ethereal: true, effects: [{ k: 'dmgHeatBonus', n: 10, bonus: 10, threshold: 5 }], upEffects: [{ k: 'dmgHeatBonus', n: 13, bonus: 13, threshold: 5 }] }))
reg(c({ id: 'coolantflush', name: 'Coolant Flush', type: 'skill', rarity: 'common', char: 'vector', cost: 0, target: 'none', effects: [{ k: 'status', to: 'self', id: 'coolant', n: 2 }], upEffects: [{ k: 'status', to: 'self', id: 'coolant', n: 3 }, { k: 'draw', n: 1 }] }))
reg(c({ id: 'ironingot', name: 'Iron Ingot', type: 'skill', rarity: 'common', char: 'vector', cost: 1, target: 'none', effects: [{ k: 'block', n: 7 }, { k: 'status', to: 'self', id: 'heat', n: 1 }], upEffects: [{ k: 'block', n: 9 }, { k: 'status', to: 'self', id: 'heat', n: 2 }] }))
reg(c({ id: 'starforge', name: 'Star Forge', type: 'attack', rarity: 'rare', char: 'vector', cost: 3, target: 'enemy', effects: [{ k: 'dmg', n: 14 }, { k: 'status', to: 'self', id: 'heat', n: 5 }], upEffects: [{ k: 'dmg', n: 20 }, { k: 'status', to: 'self', id: 'heat', n: 5 }] }))
reg(c({ id: 'heatsync', name: 'Heat Sync', type: 'skill', rarity: 'uncommon', char: 'vector', cost: 1, target: 'none', retain: true, effects: [{ k: 'status', to: 'self', id: 'heat', n: 2 }, { k: 'block', n: 4 }], upEffects: [{ k: 'status', to: 'self', id: 'heat', n: 3 }, { k: 'block', n: 6 }] }))
reg(c({ id: 'wispcall', name: 'Wisp Call', type: 'skill', rarity: 'uncommon', char: 'ghost', cost: 1, target: 'none', effects: [{ k: 'summonAlly', id: 'duskshade' }], upEffects: [{ k: 'summonAlly', id: 'duskwraith' }] }))
reg(c({ id: 'moonveil', name: 'Moon Veil', type: 'skill', rarity: 'rare', char: 'ghost', cost: 2, target: 'none', effects: [{ k: 'block', n: 10 }, { k: 'status', to: 'self', id: 'artifact', n: 1 }], upEffects: [{ k: 'block', n: 14 }, { k: 'status', to: 'self', id: 'artifact', n: 1 }], exhaust: true, upExhaust: true }))
reg(c({ id: 'spectralwaltz', name: 'Spectral Waltz', type: 'attack', rarity: 'uncommon', char: 'ghost', cost: 1, target: 'enemy', effects: [{ k: 'dmg', n: 4, times: 2 }, { k: 'enterStance', id: 'overdrive' }], upEffects: [{ k: 'dmg', n: 5, times: 2 }, { k: 'enterStance', id: 'overdrive' }] }))
reg(c({ id: 'graveblossom', name: 'Grave Blossom', type: 'skill', rarity: 'common', char: 'ghost', cost: 1, target: 'enemy', effects: [{ k: 'status', to: 'target', id: 'corrupt', n: 3 }], upEffects: [{ k: 'status', to: 'target', id: 'corrupt', n: 5 }] }))
reg(c({ id: 'fadecut', name: 'Fade Cut', type: 'attack', rarity: 'common', char: 'ghost', cost: 1, target: 'enemy', effects: [{ k: 'dmg', n: 7 }, { k: 'block', n: 3 }], upEffects: [{ k: 'dmg', n: 9 }, { k: 'block', n: 5 }] }))
reg(c({ id: 'palegate', name: 'Pale Gate', type: 'skill', rarity: 'rare', char: 'ghost', cost: 0, target: 'none', innate: true, exhaust: true, upExhaust: true, effects: [{ k: 'enterStance', id: 'stealth' }], upEffects: [{ k: 'enterStance', id: 'stealth' }, { k: 'block', n: 4 }] }))
reg(c({ id: 'winterwaltz', name: 'Winter Waltz', type: 'attack', rarity: 'uncommon', char: 'ghost', cost: 2, target: 'none', effects: [{ k: 'dmgAll', n: 6 }, { k: 'status', to: 'all', id: 'weak', n: 1 }], upEffects: [{ k: 'dmgAll', n: 8 }, { k: 'status', to: 'all', id: 'weak', n: 2 }] }))
reg(c({ id: 'mistwalk', name: 'Mist Walk', type: 'skill', rarity: 'common', char: 'ghost', cost: 2, target: 'none', effects: [{ k: 'block', n: 12 }], upEffects: [{ k: 'block', n: 16 }] }))
reg(c({ id: 'seance', name: 'Séance', type: 'skill', rarity: 'uncommon', char: 'ghost', cost: 1, target: 'none', exhaust: true, upExhaust: true, effects: [{ k: 'heal', n: 7 }, { k: 'enterStance', id: 'stealth' }], upEffects: [{ k: 'heal', n: 11 }, { k: 'enterStance', id: 'stealth' }] }))
reg(c({ id: 'noondaze', name: 'Noon Daze', type: 'attack', rarity: 'common', char: 'ghost', cost: 0, target: 'enemy', effects: [{ k: 'dmgIfStance', n: 3, bonus: 3 }], upEffects: [{ k: 'dmgIfStance', n: 5, bonus: 4 }] }))
reg(c({ id: 'omegabuffer', name: 'Omega Buffer', type: 'skill', rarity: 'uncommon', char: 'array', cost: 2, target: 'none', effects: [{ k: 'block', n: 9 }, { k: 'status', to: 'self', id: 'plating', n: 1 }, { k: 'draw', n: 1 }], upEffects: [{ k: 'block', n: 12 }, { k: 'status', to: 'self', id: 'plating', n: 1 }, { k: 'draw', n: 1 }] }))
reg(c({ id: 'turretsong', name: 'Turret Song', type: 'skill', rarity: 'common', char: 'array', cost: 0, target: 'none', effects: [{ k: 'status', to: 'self', id: 'turret', n: 1 }], upEffects: [{ k: 'status', to: 'self', id: 'turret', n: 2 }] }))
reg(c({ id: 'reclaimer', name: 'Reclaimer', type: 'attack', rarity: 'uncommon', char: 'array', cost: 1, target: 'enemy', effects: [{ k: 'dmg', n: 6 }, { k: 'heal', n: 2 }], upEffects: [{ k: 'dmg', n: 9 }, { k: 'heal', n: 3 }] }))
reg(c({ id: 'nanocloud', name: 'Nano Cloud', type: 'skill', rarity: 'uncommon', char: 'array', cost: 1, target: 'none', effects: [{ k: 'status', to: 'all', id: 'corrupt', n: 2 }, { k: 'status', to: 'self', id: 'viral', n: 1 }], upEffects: [{ k: 'status', to: 'all', id: 'corrupt', n: 3 }, { k: 'status', to: 'self', id: 'viral', n: 1 }] }))
reg(c({ id: 'unitshield', name: 'Unit Shield', type: 'skill', rarity: 'common', char: 'array', cost: 1, target: 'ally', effects: [{ k: 'block', n: 7 }], upEffects: [{ k: 'block', n: 10 }] }))
reg(c({ id: 'arcwelder', name: 'Arc Welder', type: 'attack', rarity: 'common', char: 'array', cost: 2, target: 'enemy', effects: [{ k: 'dmg', n: 10 }, { k: 'status', to: 'self', id: 'plating', n: 1 }], upEffects: [{ k: 'dmg', n: 13 }, { k: 'status', to: 'self', id: 'plating', n: 2 }] }))
reg(c({ id: 'hexcore', name: 'Hex Core', type: 'power', rarity: 'rare', char: 'array', cost: 2, target: 'none', effects: [{ k: 'status', to: 'self', id: 'viral', n: 2 }], upEffects: [{ k: 'status', to: 'self', id: 'viral', n: 3 }] }))
reg(c({ id: 'dronewall', name: 'Drone Wall', type: 'skill', rarity: 'rare', char: 'array', cost: 2, target: 'none', effects: [{ k: 'summonAlly', id: 'bulwarkpod' }, { k: 'block', n: 6 }], upEffects: [{ k: 'summonAlly', id: 'bulwarkprime' }, { k: 'block', n: 6 }] }))
reg(c({ id: 'staticpulse', name: 'Static Pulse', type: 'attack', rarity: 'common', char: 'array', cost: 1, target: 'none', effects: [{ k: 'dmgAll', n: 4 }, { k: 'draw', n: 1 }], upEffects: [{ k: 'dmgAll', n: 6 }, { k: 'draw', n: 1 }] }))
reg(c({ id: 'coreoverdrive', name: 'Core Overdrive', type: 'power', rarity: 'uncommon', char: 'array', cost: 2, target: 'none', effects: [{ k: 'status', to: 'self', id: 'focus', n: 1 }, { k: 'status', to: 'self', id: 'plating', n: 1 }], upEffects: [{ k: 'status', to: 'self', id: 'focus', n: 1 }, { k: 'status', to: 'self', id: 'plating', n: 2 }] }))
reg(c({ id: 'blackcap', name: 'Black Cap', type: 'skill', rarity: 'uncommon', cost: 1, target: 'none', effects: [{ k: 'block', n: 5 }, { k: 'status', to: 'self', id: 'str', n: 1 }], upEffects: [{ k: 'block', n: 7 }, { k: 'status', to: 'self', id: 'str', n: 1 }], exhaust: true, upExhaust: true }))
reg(c({ id: 'switchblade', name: 'Switchblade', type: 'attack', rarity: 'common', cost: 1, target: 'enemy', effects: [{ k: 'dmg', n: 5, times: 2 }], upEffects: [{ k: 'dmg', n: 7, times: 2 }] }))
reg(c({ id: 'warchest', name: 'War Chest', type: 'skill', rarity: 'rare', cost: 2, target: 'none', effects: [{ k: 'block', n: 8 }, { k: 'draw', n: 2 }], upEffects: [{ k: 'block', n: 11 }, { k: 'draw', n: 2 }] }))
reg(c({ id: 'tourniquet', name: 'Tourniquet', type: 'skill', rarity: 'uncommon', cost: 0, target: 'ally', exhaust: true, upExhaust: true, effects: [{ k: 'heal', n: 6 }], upEffects: [{ k: 'heal', n: 10 }] }))
