...
- **Ascension 0–5** (win to unlock the next level: tougher enemies, leaner
  rewards, a starter curse at A2+), a **daily seeded run**, an end-of-run
  **score breakdown**, and local run history (with scores) on the menu.
- **20 statuses**: Strength, Weak, Vulnerable, Corrupt (poison), Thorns,
  Plating, Turret, Viral, Overclock, Uplink, Ritual, Regen, Barricade, Kernel,
  Hyperthread, Chronic, and VECTOR's Heat / Coolant / Ignition / Reactor.
